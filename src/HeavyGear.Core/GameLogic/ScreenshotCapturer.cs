    ...
    public partial class ScreenshotCapturer : GameComponent
    {
        ...
        private void MakeScreenshot()
        {
            try
            {
                ...
                // TODO-MG: Screenshot capture – use Device.GetBackBufferData<Color> + PNG save
                //   int[] pixels = new int[BaseGame.Width * BaseGame.Height];
                //   BaseGame.Device.GetBackBufferData(pixels);
                //   ... write to ScreenshotNameBuilder(screenshotNum) as PNG
            }
            catch (Exception ex)
            {
