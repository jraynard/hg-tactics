...
namespace HeavyGear.GameLogic
{
    ...
    public static class Input
    {
        ...
        /// <summary>
        /// Returns true if the user moves the mouse.
        /// </summary>
        ...
        /// </summary>
        private static GamePadState gamePadState = new GamePadState();
        private static GamePadState gamePadStateLastFrame = new GamePadState();
        ...
        internal static void Update()
        {
            ...
            if (HeavyGearManager.InMenu == false &&
                // App must be active
                HeavyGearManager.IsAppActive)
            {
